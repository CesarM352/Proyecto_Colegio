    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Cursos</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Horario</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Record Académico</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Estado de Cuenta</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Biblioteca Virtual</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Asistencias</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Utilitarios</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Normas del Colegio</a>
                    <a href="#">
                        <i class="fas fa-briefcase"></i> Docentes</a>
